...
@section('title')
    Admin Panel | Manage Sub Categories
@endsection
                ...
                <div class="col-Select inputs12 data_tables">
                    <div class="card ">
                        <div class="card-header bg-white">
                            <i class="fa fa-table"></i> Manage Sub-Categories
                        </div>
                        <div class="card-body ">
                            ...
                            <table id="example2" class="display table table-stripped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th width="25%;">Name Eng.</th>
                                    <th width="25%;">Name Bang.</th>
                                ...
                                @foreach($data as $row)
                                    <tr>
                                        <td>{{$i++}}</td>
                                        <td>{{ App\Category::getData($row->parent, 'title_bang') }}</td>
                                        <td>{{ $row->title }}</td>
                                        <td>{{ $row->title_bang }}</td>
                                        <td>{{ $row->slug }}</td>
                                        <td>
                                            <a href="{{route('sub-categories.show', $row->id)}}" data-toggle="tooltip" data-placement="top" title="View User"><i class="fa fa-eye text-success"></i></a>&nbsp; &nbsp;
                                            <a href="{{route('sub-categories.edit', $row->id)}}" class="edit" data-toggle="tooltip" data-placement="top" title="Edit" ><i class="fa fa-pencil text-warning"></i></a>&nbsp; &nbsp;
                                            ...
                                            <form id="delCategoryForm{{$row->id}}" action="{{route('del-sub-category')}}" method="POST">
                                                @csrf
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form  id="categoryForm" method="post" action="{{ route('sub-categories.store') }}" enctype="multipart/form-data" name="categoryForm" class="form-horizontal">
