            ...
            <div class="row no-gutters">
                ...
                <div class="col-sm-7 col-lg-6">
                    <ol  class="breadcrumb float-right nav_breadcrumb_top_align">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('Merchants.show', $data->id)}}">{{ $data->title}}</a>
                        </li>
                ...
                <div class="col-12 data_tables">
                    <div class="card ">
                        <div class="card-header bg-white">
                            <i class="fa fa-table"></i> Update Merchant Information
                        </div>
                        <div class="card-body ">
                            <div align="right">
                                <a href="{{ route('Merchants') }}" class="btn btn-primary">Back</a>
                            </div>
                            <br />
                            <form  id="categoryForm" method="post" action="{{ route('merchants.update', $data->id) }}" enctype="multipart/form-data" name="categoryForm" class="form-horizontal">
                            ...
                            <!--<input type="hidden" name="writer_id" id="writer_id"> -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select name="athorised_person" id="athorised_person" class="validate[required] form-control select2">
                                            <option value="{{ $data->athorised_person}}">{{ App\User::getData($data->athorised_person, 'name').'_'.App\User::getData($data->athorised_person, 'phone')}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <img src="{{ URL::to('/') }}/uploads/Merchants/{{ $data->image }}" class="img-thumbnail" width="100" />
                                        <input type="hidden" name="hidden_image" value="{{ $data->image }}" />
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="name" class="col-sm-12 control-label"> Merchants Status</label>
                                    <div class="col-sm-12">
