...
<span class=" text-white"><span class="degree">25&deg;</span>
                                    ...
                                    <div class="row weekly_report">
                                        <div class="col-3">
                                            <span>Mon</span>
                                            <br/>
                                            <img src="{{asset('/')}}admin/img/w1.png" alt="weather">
                                            <p>27&deg;</p>
                                        </div>
                                        <div class="col-3">
                                            <span>Tue</span>
                                            <br/>
                                            <img src="{{asset('/')}}admin/img/w2.png" alt="weather">
                                            <p>23&deg;</p>
                                        </div>
                                        <div class="col-3">
                                            <span>Wed</span>
                                            <br/>
                                            <img src="{{asset('/')}}admin/img/w3.png" alt="weather">
                                            <p>19&deg;</p>
                                        </div>
                                        <div class="col-3">
                                            <span>Thu</span>
                                            <br/>
                                            <img src="{{asset('/')}}admin/img/w4.png" alt="weather">
                                            <p>38&deg;</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="Browser_stats_ul">
                                <li><span><img alt="google" src="{{asset('/')}}admin/img/chrome.png"/>Google Crome</span><span
                                        class="float-right text-mint">32%<i
                                            class="fa fa-level-up"></i></span>
                                    <hr/>
                                </li>
                                <li><span><img alt="firebox" src="{{asset('/')}}admin/img/firefox.png">Firefox</span><span
                                        class="float-right text-danger">5%<i
                                            class="fa fa-level-down"></i></span>
                                    <hr/>
                                </li>
                                <li><span><img alt="safari" src="{{asset('/')}}admin/img/safari2.png">Safari</span><span
                                        class="float-right text-mint">10%<i
                                            class="fa fa-level-up"></i></span>
                                    <hr/>
                                </li>
                                <li><span><img alt="opera" src="{{asset('/')}}admin/img/opera.png">Opera</span><span
                                        class="float-right text-mint">32%<i
                                            class="fa fa-level-up"></i></span>
                                    <hr/>
                                </li>
                                <li><span><img alt="ie" src="{{asset('/')}}admin/img/Ie.png">IE</span><span
                                        class="float-right text-danger">15%<i
                                            class="fa fa-level-down"></i></span>
                                    <hr/>
                                </li>
                                <li><span><img alt="mobile" src="{{asset('/')}}admin/img/mobile1.png">Mobile</span><span
                                        class="float-right text-mint">32%<i
                                            class="fa fa-level-up"></i></span>
                                    <hr/>
                                </li>
                                <li><span><img alt="others" src="{{asset('/')}}admin/img/others.png">Others</span><span
                                        class="float-right text-mint">32%<i
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-2 col-lg-3 col-xl-2">
                                            <img src="{{asset('/')}}admin/img/images.jpg" class="rounded-circle"
                                                 alt="image not found">
                                        </div>
...
Lorem Ipsum is simply dummy text of the printing.</span>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-2 col-lg-3 col-xl-2">
                                            <img src="{{asset('/')}}admin/img/images3.jpg" class="rounded-circle"
                                                 alt="image not found">
                                        </div>
                                        <div class="col-10 col-lg-9 col-xl-10">
...
Lorem Ipsum is simply dummy text of the printing.</span>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-2 col-lg-3 col-xl-2">
                                            <img src="{{asset('/')}}admin/img/images2.jpg" class="rounded-circle"
                                                 alt="image not found">
                                        </div>
                                        <div class="col-10 col-lg-9 col-xl-10">
...
Lorem Ipsum is simply dummy text of the printing.</span>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-2 col-lg-3 col-xl-2">
                                            <img src="{{asset('/')}}admin/img/images4.jpg" class="rounded-circle"
                                                 alt="image not found">
                                        </div>
                                        <div class="col-10 col-lg-9 col-xl-10">
