...
@section('title')
    Admin Panel | View Secondary SubCategory Detail
@endsection
        ...
        <div class="inner bg-container">
            ...
            <div class="card">
                <div class="card-header bg-white">
                    <i class="fa fa-table"></i> View Category Detail
                    <!--<div align="right">
                                ...
                                <div class="form-group">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumb_zoom zoom admin_img_width">
                                            <img src="{{ URL::to('/') }}/uploads/categories/{{ $data->image }}" alt="admin" class="admin_img_width"/>
