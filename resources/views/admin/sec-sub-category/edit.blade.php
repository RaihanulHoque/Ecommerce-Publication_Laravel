...
@section('title')
    Admin Panel | Update Second Sub Category
@endsection
            ...
            <div class="row no-gutters">
                ...
                <div class="col-sm-7 col-lg-6">
                    <ol  class="breadcrumb float-right nav_breadcrumb_top_align">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('sec-sub-categories')}}"> Second Sub Categories </a>
                        </li>
                        <li class="breadcrumb-item">
            ...
            <div class="row">
                ...
                <div class="col-12 data_tables">
                    <div class="card ">
                        ...
                        <div class="card-body ">
                            <div align="right">
                                <a href="{{ route('sec-sub-categories') }}" class="btn btn-primary">Back</a>
                            </div>
                            <br />
                            <form  id="categoryForm" method="post" action="{{ route('sec-sub-categories.update', $data->id) }}" enctype="multipart/form-data" name="categoryForm" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select name="parent" id="parent" class="validate[required] form-control select2">
                                            <option value="{{ $data->parent}}">{{ App\SubCategory::getData($data->parent, 'title_bang')}}</option>
