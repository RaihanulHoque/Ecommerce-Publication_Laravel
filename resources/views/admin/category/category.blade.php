                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="categoryForm" name="categoryForm" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="col-sm-2 control-label">Category Name (Eng.)*</label>
                                                <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <label for="title_bang" class="col-sm-2 control-label">Category Name (Bang.)*</label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="title_bang" name="title_bang" placeholder="বাংলা নাম" value="" maxlength="50" required="">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="slug" class="col-sm-2 control-label">Category Slug URL *</label>
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" id="slug" name="slug" placeholder="বাংলা নাম" value="" maxlength="50" required="">
                                                </div>
                                            </div>
