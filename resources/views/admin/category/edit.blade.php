...
@section('title')
    Admin Panel | Update Main Category
@endsection
            ...
            <div class="row no-gutters">
                ...
                <div class="col-sm-7 col-lg-6">
                    <ol  class="breadcrumb float-right nav_breadcrumb_top_align">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('categories.show', $data->id)}}">{{ $data->title}}</a>
                        </li>
                ...
                <div class="col-12 data_tables">
                    <div class="card ">
                        ...
                        <div class="card-body ">
                            ...
                            <br />
                            <form  id="categoryForm" method="post" action="{{ route('categories.update', $data->id) }}" enctype="multipart/form-data" name="categoryForm" class="form-horizontal">
